...
```ts
import { defineBoltConfig } from 'https://williamhorning.dev/bolt/x/bolt/0.5.4/mod.ts';
import bolt_discord from 'https://williamhorning.dev/bolt/x/bolt-discord/0.5.4/mod.ts';
